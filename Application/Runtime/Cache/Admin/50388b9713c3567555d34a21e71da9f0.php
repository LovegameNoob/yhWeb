...
<nav class="text-center">
    <ul class="pagination pagination-lg">
        ...
        <?php $__FOR_START_5745__=1;$__FOR_END_5745__=$allpage+1;for($i=$__FOR_START_5745__;$i < $__FOR_END_5745__;$i+=1){ ?><li class="page"><a href="#"><?php echo ($i); ?></a></li><?php } ?>
        </volist>
        <li>
...
<script>
    $(function () {
        ...
        $('.page').click(function () {
            ...
            $.post('/yhWeb/Admin/Type/ajaxPage', {page: $(this).text()}, function (data) {
                $('#ajaxpage').html(data);
            })
        })
        $('#previous').click(function () {
            if ($('.active').prev().hasClass('page')) {
                ...
                $.post('/yhWeb/Admin/Type/ajaxPage', {page: index}, function (data) {
                    $('#ajaxpage').html(data);
                })
            }
        })
