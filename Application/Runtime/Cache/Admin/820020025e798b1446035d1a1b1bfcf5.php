    ...
    <tr>
        <td align="left" valign="top">
            ...
            <?php if (is_array($type)): $i = 0;
                ...
                else: foreach ($__LIST__ as $key => $showType): $mod = ($i % 2);
                    ++$i; ?>
                <table class="table table-bordered table-striped table-hover text-center" index="<?php echo($key); ?>" style="display: none">
                    <tr>
                        <th>编号</th>
                        <th>类名</th>
                        <th>父类ID</th>
...
<nav class="text-center">
    <ul class="pagination pagination-lg">
        ...
        <?php $__FOR_START_32673__ = 1;
        $__FOR_END_32673__ = $allpage + 1;
        for ($i = $__FOR_START_32673__; $i < $__FOR_END_32673__; $i += 1) { ?>
            <li class="page"><a href="#"><?php echo($i); ?></a></li><?php } ?>
        </volist>
        <li>
