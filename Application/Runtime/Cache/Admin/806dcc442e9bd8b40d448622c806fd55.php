        ...
        <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="/yhWeb/Admin/Member/addMember" target="mainFrame" onFocus="this.blur()" class="add">新增会员</a></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr>
                    ...
                    <th align="center" valign="middle" class="borderright">会员帐号</th>
...
<script>
    ...
    function ban(id) {
        ...
        $.post('/yhWeb/Admin/Member/ban', {id: id}, function (data) {
            if (data.status == '1') {
                var b = $('.flag_' + id).html();
                if (b == '1') // '1'  '0'
                {
