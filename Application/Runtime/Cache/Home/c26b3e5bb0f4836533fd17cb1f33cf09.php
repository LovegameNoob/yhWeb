        ...
        <div class="nav">
            ...
            <div class="leftNav none">
                <ul>
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav1.png"/></span>
                        ...
                        <div class="zj">
                            ...
                            <div class="zj_r">
                                <a href="#"><img src="/yhWeb/Public/Home/Images/n_img1.jpg" width="236" height="200"/></a>
                                <a href="#"><img src="/yhWeb/Public/Home/Images/n_img2.jpg" width="236" height="200"/></a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav2.png"/></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav3.png"/></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav4.png"/></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav5.png"/></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav6.png"/></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav7.png"/></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav8.png"/></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav9.png"/></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/yhWeb/Public/Home/Images/nav10.png"/></span>
...
<div class="i_bg">
    <div class="content mar_20">
        <img src="/yhWeb/Public/Home/Images/img3.jpg"/>
    </div>
    ...
    <div class="content mar_20">
        ...
        <div class="warning">
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
                <tr height="35">
                    <td style="font-size:18px;">
                        感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font color="#ff4e00"><?php echo ($orderCode); ?></font>
                    </td>
                </tr>
                <tr>
                    <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                        您选定的配送方式为: <font color="#ff4e00">申通快递</font>； &nbsp; &nbsp;您选定的支付方式为: <font color="#ff4e00">银行卡</font>； &nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥<?php echo ($total); ?></font>
                    </td>
                </tr>
                <tr>
                    <td style="padding:20px 0 30px 0; font-family:'宋体';">
                ...
                <tr>
                    <td>
                        ...
                        <a href="/yhWeb/Home/Index">首页</a> &nbsp; &nbsp; <a href="/yhWeb/Home/Member">用户中心</a>
                    </td>
                </tr>
            </table>
        </div>
