        ...
        <div class="m_right">
            <div class="m_des">
                <table border="0" style="width:870px; line-height:22px;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        <td width="115"><img src="/yhWeb/Public/Home/Images/user.jpg" width="90" height="90"/></td>
                        <td>
                            <div class="m_user"><?php echo ($user["userName"]); ?></div>
                            <p>
                                等级：注册用户 <br/>
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="40%">用户ID：<span style="color:#555555;"><?php echo ($user["id"]); ?></span></td>
                    <td width="60%">邀请人：<span style="color:#555555;">邀请人姓名</span></td>
                </tr>
                <tr>
                    <td>电&nbsp; &nbsp; 话：<span style="color:#555555;"><?php echo ($user["phone"]); ?></span></td>
                    <td>邮&nbsp; &nbsp; 箱：<span style="color:#555555;"><?php echo ($user["email"]); ?></span></td>
                </tr>
                <tr>
                    <td>身份证号：<span style="color:#555555;"><?php echo ($user["idCard"]); ?></span></td>
                    <td>注册时间：<span style="color:#555555;"><?php echo (date("Y-m-d",$user["regTime"])); ?></span></td>
                </tr>
            </table>
